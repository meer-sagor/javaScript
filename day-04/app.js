...
// const findIndex = myArray.indexOf(2);
// myArray.splice(findIndex, 1)
// console.log(myArray);
...
let arrayOfObject = [
  ...
  arrayOfObject.map(function(item, index){
      if(item.id === 4 && item.website === 'kale.biz' && item.username === 'Karianne'
      ){
        console.log(item);
  ...
  // myArray.map(function(i, indx, arr){
  //   if(i === 10){
  //     console.log(indx);
  //     console.log('hey');
  //   }
  ...
  // function myIndexOf(array, number){
  ...
  //   })
  // }
  // myIndexOf(myArray, 10)
  
  
  
  //  const value = myArray.indexOf(5)
  //  console.log(value)
